  ...
  return (
    <>
      <div className="min-h-screen flex flex-col items-center justify-center bg-black p-4 relative">
        ...
        <div className=" absolute bottom-4 w-2/3 z-10 flex justify-between items-center px-8 2xl:hidden">
          <img
            src={icon1}
            alt="Icon 1"
            className="hidden 2xl:block w-8 h-8  sm:w-12 sm:h-12 md:w-16 md:h-16 absolute left-8 bottom-7"
          />
        ...
        <div className="absolute top-5 left-8 lg:top-5 sm:left-16 md:left-24 lg:left-48 xl:left-96 transform -translate-x-1/2 z-10 2xl:hidden">
          
            <img
              src={icon}
              alt="icon"
              className="w-16 h-18 sm:w-24 sm:h-24 md:w-28 md:h-28 lg:w-32 lg:h-32 xl:w-40 xl:h-40 object-contain"
            />
        </div>
      ...
      <div className="backdrop-blur-lg bg-white/96 flex flex-col md:flex-row items-center bg-white rounded-lg shadow-md p-6 max-w-4xl mx-auto 2xl:hidden">
        <img
          src={ques}
          alt="About Us Icon"
        ...
        <div>
          <p className="text-gray-800">
            The Financial Document Analyzer streamlines the extraction of key
            data from unstructured financial documents, such as company annual
            reports. Simply upload your documents, and our tool will
            automatically process them using advanced AI models to generate
            structured data. You can then query the document, allowing you to
            easily search for specific details and insights.
          </p>
        </div>
      </div>
    </>
