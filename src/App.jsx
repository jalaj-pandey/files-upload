...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-black p-4 relative">
      <div className="absolute top-4 left-16 sm:left-16 md:left-96 transform -translate-x-1/2 z-10">        
      <a href="https://thejalaj.netlify.app/" target="_blank" rel="noopener noreferrer">
  <img
    src={icon}
    alt="icon"
  ...
  />
      ...
      <div className="absolute bottom-4 w-2/3 z-10 flex justify-between items-center px-8">
        <img src={icon1} alt="Icon 1" className="hidden xl:block w-8 h-8  sm:w-12 sm:h-12 md:w-16 md:h-16 absolute left-8 bottom-7" />

        <img src={icon6} alt="Icon 1" className="hidden xl:block w-8 h-8  sm:w-12 sm:h-12 md:w-16 md:h-16 absolute left-2 bottom-72" />

        <img src={icon2} alt="Icon 2" className="hidden xl:block w-8 h-8 sm:w-12 sm:h-12 md:w-16 md:h-16 absolute right-1/2 bottom-0" />

        <img src={icon3} alt="Icon 3" className="hidden xl:block w-8 h-8 sm:w-12 sm:h-12 md:w-16 md:h-16 absolute right-4 bottom-96" />

        <img src={icon5} alt="Icon 3" className="hidden xl:block w-8 h-8 sm:w-12 sm:h-12 md:w-16 md:h-16 absolute right-7 sm:right-10 md:right-7 bottom-8 sm:bottom-36 md:bottom-8" />
      </div>
